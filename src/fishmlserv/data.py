...
def add_prediction_column(csv_file_path='/home/tommy/code/fishmlserv/note/fish_test_data_100k.csv'):
    """
...
def add_prediction_column_api(csv_file_path='/home/tommy/code/fishmlserv/note/fish_test_data_100k.csv'):
    """
    CSV 파일의 데이터를 읽어와 각 행에 대한 예측 결과를 새로운 컬럼에 추가합니다.
